...
// these will extends all the "TodoItemContainer" styled plus new styles (like inheritance)
...
const TodoListItem = ({ todo, onRemovePressed, onCompletedPressed }) => {
  //If the todo is incompleted then use "TodoItemContainerWithWarning" to apply the red border only to incomplete todos
